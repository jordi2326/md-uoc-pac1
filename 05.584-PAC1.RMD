...
* L'aula laboratori de R/Python per resoldre dubtes o problemes.
...
*****
# Exemple de solució mínim de l'exercici 2. 
*****
No es tracta d'una pauta per a repetir sinó diferents exemples per donar-vos idees per inspirar-vos.
...
barplot(prop.table(counts), beside = TRUE, col = colors, 
        ...
        ylab = "Percentatge",
        main = "Distribució d'accidents per morts i conductors positius en alcohol",
...
barplot(prop.table(counts), main="Distribució d'accidents per conductors positius en alcohol i nombre de morts",
...
**VE_FORMS** nombre de vehicles en moviment implicats
**PVH_INVL** nombre de vehicles estacionats implicats
**PEDS**     nombre de vianant implicats
**PERSONS**  nombre d'ocupant de vehicle implicats
**PERMVIT**  nombre conductors i ocupants implicats
...
+ També podem limitar el nombre de components a aquest nombre que representa una determinada fracció de la variància total. Per exemple, si estem satisfet amb el 70% de la variància total explicada, fem servir el nombre de components per aconseguir-ho que són les 4 components principals vists abans.
...
L'objectiu del projecte està correctament definit amb prou concreció i es pot resoldre amb tècniques de mineria de dades.	10%
...
Es tracta en profunditat algun altre aspecte respecte a les dades presentat en els mòduls "Preprocessat de les dades i gestió de característiques".	15%
